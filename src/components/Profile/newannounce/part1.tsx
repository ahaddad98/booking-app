            ...
            <div className="inputs">
                <div className="inputsleft">
                    <div className="partinp">
                        ...
                        <Input type="text" bordered={false} placeholder='Villa' className='inp' />
                    </div>
                    <div className="partinp">
                        <div className="text">
                            Type du service
                ...
                <div className="inputright">
                    ...
                    <div className="partinp">
                        ...
                        <Input type="text" bordered={false} className='inp' />
                    </div>
                </div>
            </div>
        </div>
        <div className="bottons">
            <Button type="primary" className="cancel" onClick={()=> his.push('/profile/announce')}>Cancel</Button>
            <Button type="primary" className="next" onClick={()=> his.push('/profile/part2')}>
                <div>
                    Next
                </div>
