...
const Part2 = (props: any) => {
    ...
    const onstatusChange = (value: string) => {
        ...
        switch (value) {
            ...
            case 'GOOD':
                ...
                return;
            case 'REFORM':
                form.setFieldsValue({ status: 'REFORM' });
                return;
        }
    };
    const onservChange = (value: string) => {
        ...
        switch (value) {
            case 'WEST':
                form.setFieldsValue({ orientation: 'WEST' });
                return;
            case 'NORTH':
                form.setFieldsValue({ orientation: 'NORTH' });
                return;
            case 'EAST':
                form.setFieldsValue({ orientation: 'EAST' });
                return;
            case 'SOUTH':
                form.setFieldsValue({ orientation: 'SOUTH' });
        }
    };
    const onservChange1 = (value: string) => {
        // console.log(value);
        ...
        switch (value) {
            case 'WOODEN':
                {
                    // console.log('asdads');
                    console.log(form.setFieldsValue({ flooring: 'WOODEN' }));
                    return;
                }
            case 'MARBLE':
                form.setFieldsValue({ flooring: 'MARBLE' });
                return;
            case 'TILED':
                form.setFieldsValue({ flooring: 'TILED' });
                return;
            case 'OTHER':
                form.setFieldsValue({ flooring: 'OTHER' });
        }
    };
    return <Content>
        <Form
                    ...
                    <div className="inputsleft">
                        ...
                        >
                            <div className="partinp">
                                ...
                                <Select bordered={false} placeholder='Status' className='inp' onChange={onstatusChange}>
                                    <Select.Option value="NEW">NEW</Select.Option>
                                    <Select.Option value="GOOD">GOOD</Select.Option>
                                    <Select.Option value="REFORM">REFORM</Select.Option>
                                </Select>
                            </div>
                        </Form.Item>
                        <Form.Item
                        ...
                        >
                            <div className="partinp">
                                ...
                                <Select bordered={false} placeholder='Orientation' className='inp' onChange={onservChange}>
                        ...
                        <Form.Item
                            label=""
                            name="flooring"
                            rules={[{ required: true, message: 'Please input Flooring' }]}
                        >
                            <div className="partinp">
                                <div className="text">
                                    Flooring
                                </div>
                                <Select bordered={false} placeholder='Flooring' className='inp' onChange={onservChange1}>
                                    <Select.Option value="WOODEN">WOODEN</Select.Option>
                                    <Select.Option value="MARBLE">MARBLE</Select.Option>
                                    <Select.Option value="TILED">TILED</Select.Option>
                        ...
                        >
                            <div className="partinp">
                                ...
                                <Input type="number" bordered={false} placeholder='Adress' className='inp' />
                            </div>
                        </Form.Item>
                    </div>
                </div>
